	...
	public override void OnInspectorGUI()
	{
		...
		if(!isMarker)
		{
			...
			switch(conditionType)
			{
				...
				case TimeMachineBehaviour.Condition.WalkingToDestination:
					EditorGUILayout.HelpBox("The above action will be executed if enemy agent is walking to the destination.", MessageType.Info);
					EditorGUILayout.Space();
					EditorGUILayout.PropertyField(conditionProp);
